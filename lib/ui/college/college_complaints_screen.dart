...
class CollegeComplaintsScreen extends StatefulWidget {
  const CollegeComplaintsScreen({Key? key}) : super(key: key);

  @override
  State<CollegeComplaintsScreen> createState() => _CollegeComplaintsScreenState();
}

class _CollegeComplaintsScreenState extends State<CollegeComplaintsScreen> with LoadMoreListener{
  late CollegeComplaintBloc _bloc;
  late ScrollController _itemsScrollController;
  bool isLoadingMore = false;
  List<Profiles> filteredComplaintsList = [];
  @override
  void initState() {
    _bloc = CollegeComplaintBloc(listener: this);
