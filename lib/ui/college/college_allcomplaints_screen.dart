...
class CollegeAllComplaintsScreen extends StatefulWidget {
  const CollegeAllComplaintsScreen({Key? key}) : super(key: key);

  @override
  State<CollegeAllComplaintsScreen> createState() => _CollegeAllComplaintsScreenState();
}

class _CollegeAllComplaintsScreenState extends State<CollegeAllComplaintsScreen> with LoadMoreListener {
  late CollegeOtherComplaintBloc _bloc;
  ...
  Widget _buildAllComplaintList(List<Profiles> complaintsList) {
    return Padding(
